...
<head>
	...
	<link rel="stylesheet" href="/myoA/Public/Admin/css/login.css" />
			...
			<div class="login1">
                ...
                <div class="login-input">
                    ...
                    <p class="yzm ue-clear">
                        ...
                        <cite><img src="/myoA/index.php/Admin/Public/captcha" onclick="this.src='/myoA/index.php/Admin/Public/captcha/t/'+Math.random()" /></cite>
                    </p>
                </div>
