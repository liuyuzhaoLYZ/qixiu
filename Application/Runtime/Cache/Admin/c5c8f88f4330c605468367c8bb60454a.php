...
<link rel="stylesheet" href="/myoA/Public/Admin/css/info-reg.css" />
<title>移动办公自动化系统</title>
<style type='text/css'>
	select {
		background: rgba(0, 0, 0, 0) url("/myoA/Public/Admin/images/inputbg.png") repeat-x scroll 0 0;
...
<form action="/myoA/index.php/Admin/User/edit" method="post">
<div class="main">
    ...
    <div class="short-input select ue-clear">
        ...
        <select name="dept_id">
            ...
            <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vol["id"]); ?>"<?php if($vol["id"] == $data["id"] ): ?>selected="selected"<?php endif; ?>><?php echo ($vol["deptname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
    </div>
	<p class="short-input ue-clear">
    	<label>性别：</label>
